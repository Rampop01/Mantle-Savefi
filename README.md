...
SaveFi is a no-loss lottery protocol built on Mantle network. Users deposit stablecoins which are invested in yield-generating strategies, and the yield is distributed as prizes through weekly draws.
