...
export default function YieldAnalyticsPage() {
  ...
  const fmtPct = (v?: bigint) => (v !== undefined ? `${(Number(v) / 100).toFixed(2)}%` : "—")
      ...
      <main className="p-4 md:p-6 space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <Card className="bg-white/5 border-purple-500/20 backdrop-blur-sm">
            ...
            <CardContent><div className="text-2xl font-bold text-cyan-400">{fmt6(totalYield)} USDC</div></CardContent>
          </Card>
          <Card className="bg-white/5 border-purple-500/20 backdrop-blur-sm">
          ...
          <Card className="bg-white/5 border-purple-500/20 backdrop-blur-sm">
            <CardHeader className="pb-2"><CardTitle className="text-sm text-gray-400">Prize Pool</CardTitle></CardHeader>
            <CardContent><div className="text-2xl font-bold">{fmt6(prizePool)} USDC</div></CardContent>
          </Card>
        </div>
